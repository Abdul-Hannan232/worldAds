        ...
        <div className="lg:w-[60%] w-[90%]  lg:mx-0 mx-auto lg:mt-40 mt-10">
          ...
          <div className="h-[400px] overflow-scroll ">
            <div className="flex items-center lg:justify-start justify-center w-full gap-5  mt-10">
              <h1 onClick={precisionOpen} className={`${precision?"xl:text-3xl text-[#7E7E7E33]":"xl:text-2xl text-[#030303]"}lg:text-2xl lg:text-start text-center  text-2xl 2xl:text-6xl xl:w-[50%] lg:w-[60%]  2xl:w-[90%] font-bold `}>Precision Targeting</h1>
