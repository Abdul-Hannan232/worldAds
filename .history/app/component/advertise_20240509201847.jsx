      ...
      <div id="advertise" className="xl:pl-32 2xl:pl-40   lg:flex lg:mt-48 mt-32 w-full background gap-24">
        ...
        <div className="lg:w-[60%] w-[90%]  lg:mx-0 mx-auto lg:mt-40 mt-10">
          ...
          <div className="h-[400px] overflow-scroll ">
            <div onClick={precisionOpen} className="flex items-center lg:justify-start justify-center w-full gap-5  mt-10">
              <h1 className="xl:text-2xl lg:text-2xl lg:text-start text-center  text-2xl 2xl:text-6xl xl:w-[70%] lg:w-[60%]  2xl:w-[90%] font-bold text-[#030303]">Precision Targeting</h1>
              <hr className="border w-full lg:block hidden  border-[#FC3603]" />
            </div>
      {precision}      <p className="lg:text-xl text-sm 2xl:text-2xl lg:w-80 lg:text-start w-40 lg:mx-0 mx-auto text-center mt-5"> Reach your ideal audience at the right time and place.</p>
            ...
            <div className="flex items-center lg:justify-start justify-center gap-5 w-full mt-10">
              <h1 className="xl:text-xl lg:text-2xl  text-2xl  2xl:text-6xl font-bold lg:text-start text-center  xl:w-[50%] lg:w-[45%] 2xl:w-[60%] text-[#030303]">Dynamic HD Quality Ads</h1>
            ...
            <div className="flex items-center lg:justify-start justify-center w-full mt-10">
              <h1 className="xl:text-xl lg:text-3xl  text-2xl  2xl:text-6xl font-bold lg:text-start text-center  xl:w-[80%] lg:w-[60%] 2xl:w-full text-[#030303]">Scalable Geofenced Campaigns</h1>
              <hr className="border  w-full lg:block hidden border-[#FC3603]" />
            </div>
