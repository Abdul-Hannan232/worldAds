          ...
          <div className="h-[400px] overflow-scroll">
            <div className="flex items-center lg:justify-start justify-center w-full gap-5 mt-10">
              <h1
                ...
                className={`${precision ? "xl:text-3xl text-[#030303]" : "xl:text-2xl text-gray-400"
            ...
            <div className="flex items-center lg:justify-start justify-center gap-5 w-full mt-10">
              <h1
                onClick={dynamicDrop}
                className={`${dynamic ? "xl:text-2xl text-[#030303]" : "xl:text-xl text-gray-400"
              ...
              <hr className={`${scalable ?"lg:block hidden":"hidden"}   border w-[50%] lg:block hidden 2xl:w-[400px] border-[#FC3603]`} />
            </div>
            ...
            <div className="flex items-center lg:justify-start justify-center w-full mt-10">
              <h1
                ...
                className={`${scalable ? "xl:text-3xl text-[#030303]" : "xl:text-2xl text-gray-400"
              ...
              <hr  className={`${scalable ?"lg:block hidden":"hidden"}  border w-[73%] border-[#FC3603]`} />
            </div>
