    ...
    return (
        <div className={`fixed w-full z-40 ${isHeaderFixed ? 'bg-red-600 py-5 lg:p-5' : 'bg-transparent py-10 lg:p-10'}`}>
            <div className="relative w-[85%] mx-auto flex justify-between items-center bg-transparent">
                ...
                >
                    <div className='w-[100%] gradient-color absolute top-0 right-0 left-0 border border-white rounded-xl h-60 '>
                        <ul className="px-5   space-y-3  text-center text-lg text-white ">
                            ...
                            <li className='font-medium'><a href="#nodeOperator" onClick={() => scrollToSection('nodeOperator')}>Node Operators</a></li>
                            <li className='font-medium'><a href="#ride">Ride & Earn</a></li>
                            <li className='font-medium'><a href="#advertise">Advertise With WorldAds</a></li>
                        </ul>
                    </div>
                    {open && (
