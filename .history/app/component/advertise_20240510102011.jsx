  ...
  return (
    <div className="">
      ...
      <h1
        ...
        className={`${
          precisionOpen ? "xl:text-3xl text-[#030303]" : "xl:text-2xl text-gray-400"
    ...
    <div className={`transition-all duration-500 ${precisionOpen ? 'max-h-96' : 'max-h-0 overflow-hidden'}`}>
      {precisionOpen && (
        <p  
