        ...
        <div className="lg:w-[60%] w-[90%]  lg:mx-0 mx-auto lg:mt-40 mt-10">
          ...
          <hr className="border w-[70%] lg:block hidden  border-[#FC3603]" />
            ...
            <div className="flex items-center lg:justify-start justify-center gap-5 w-full mt-10">
              <h1 id=""className="xl:text-xl lg:text-2xl  text-2xl  2xl:text-6xl font-bold lg:text-start text-center  xl:w-[50%] lg:w-[45%] 2xl:w-[60%] text-[#030303]">Dynamic HD Quality Ads</h1>
