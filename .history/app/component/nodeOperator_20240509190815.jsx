...
const nodeOperator = () => {
    return (
        <>
            <div className="lg:flex w-[80%] mt-80 h-screen mx-auto items-end justify-between">
                <div >
                    <Image src="/Group 1.png" alt="Image" width={203} height={207} className="lg:w-[493px] lg:h-[497px] lg:mx-0 mx-auto " />
                </div>
                <div id="nodeOperator" className="xl:w-[500px]  md:w-[400px] lg:mt-0 mt-10 lg:mx-0 mx-auto">
