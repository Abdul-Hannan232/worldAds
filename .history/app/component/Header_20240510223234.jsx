                ...
                >
                    <div className='w-[100%] gradient-color absolute top-0 right-0 left-0 border border-white rounded-xl h-60 '>
                        <ul className="px-5   space-y-3  text-center text-lg text-white ">
                            ...
                            <li className='font-'><a href="#nodeOperator" onClick={() => scrollToSection('nodeOperator')}>Node Operators</a></li>
                            <li className='font-'><a href="#ride">Ride & Earn</a></li>
                            <li className='font-'><a href="#advertise">Advertise With WorldAds</a></li>
                        </ul>
                    </div>
                    {open && (
