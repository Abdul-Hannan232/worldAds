          ...
          {dynamic && (
           <p className="lg:text-xl text-sm 2xl:text-2xl lg:w-80 w-52 lg:mx-0 mx-auto  lg:text-start text-center mt-5">Captivate viewers with stunning, crystal-clear advertisements.</p>
            ...
            <div className="flex items-center lg:justify-start justify-center w-full mt-10">
              <h1 onClick={ScalableDrop} className={`${dynamic ? "xl:text-2xl text-[#030303]" : "xl:text-xl text-gray-400 "}  xl:text-xl lg:text-3xl  text-2xl  2xl:text-6xl font-bold lg:text-start text-center  xl:w-[80%] lg:w-[60%] 2xl:w-full text-[#030303]">Scalable Geofenced Campaigns</h1>
              <hr className="border   w-[70%] lg:block hidden border-[#FC3603]" />
            </div>
          {scalable && (
