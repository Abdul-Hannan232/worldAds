        ...
        <div className="lg:w-[60%] w-[90%]  lg:mx-0 mx-auto lg:mt-40 mt-10">
          ...
          <div className="h-[400px] overflow-scroll">
            ...
            <div className="flex items-center lg:justify-start justify-center gap-5 w-full mt-10">
              <h1 onClick={dynamicDrop}  className={`${dynamic ? "xl:text-xl text-[#030303]" : "xl:text-2xl text-gray-400 "} lg:text-2xl cursor-pointer  text-2xl  2xl:text-6xl font-bold lg:text-start text-center  xl:w-[50%] lg:w-[45%] 2xl:w-[60%] `}>Dynamic HD Quality Ads</h1>
